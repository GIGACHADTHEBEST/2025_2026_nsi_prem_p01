...
Raphaël Botalla 
 ...
 Ce projet consite à simuler un distributeur automatique de billets. 
 Chaque client a un compte avec son nom relié à un code PIN. Pour utiliser de l argent présent sur ce comppte, l'utilisateur doit rentrer son code PIN. 
