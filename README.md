...
La partie du programme visant à décomposer le montant de la somme d'argent que l'utilisateur cherche à retirer consiste à :
    ...
    - Afficher de manière claire la répartition des billets automatiques ou choisies par l'utilisateur ainsi que les propositions données par le programme (ex: "Choisis un montant à retirer") et enfin les messages d'erreurs si il y en a eu avec la fonction "afficher-billets".
